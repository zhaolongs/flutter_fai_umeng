 ...
 */
public class FlutterFaiUmengPlugin extends FlutterApplication implements MethodCallHandler, EventChannel.StreamHandler {
    public EventChannel.EventSink eventSink;
    private String CHANNEL = "flutter_umpush_plugin";

    public static FlutterFaiUmengPlugin instance;
    private static String TAG = "| UMPUSH | Flutter | Android | ";
    private final Registrar registrar;
    private final MethodChannel channel;
    public final Map<Integer, Object> callbackMap;
    ...
    public static void registerWith(Registrar registrar) {
        ...
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_and_native_um_101");
        channel.setMethodCallHandler(new FlutterFaiUmengPlugin(registrar, channel));
